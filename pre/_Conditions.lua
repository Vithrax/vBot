...
macro(500, function()
    ...
    elseif (not storage[conditionPanelName].ignoreInPz or not isInPz()) and storage[conditionPanelName].holdUtana and mana() >= storage[conditionPanelName].utanaCost and (not utanaCast or (now - utanaCast > 120000)) then
        say("utana vid")
        utanaCast = now
    end
end)
